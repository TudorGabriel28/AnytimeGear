...
export default function RentalTable({ rows }: { rows: RentalTableData[] }) {
    const [order, setOrder] = React.useState<Order>('asc');
    const [orderBy, setOrderBy] = React.useState<keyof RentalTableData>('endDate');
    ...
    const handleRequestSort = (
        ...
        property: keyof RentalTableData,
    ) => {
